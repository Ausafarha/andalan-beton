...
<div class="grid grid-4 mb-20">
  <div class="stat-card" style="--stat-color: var(--brand-500); cursor: pointer;" onclick="window.location.href='<?= APP_URL ?>/admin/modules/material/index.php'">
  ...
  <div class="stat-card" style="--stat-color: var(--success); cursor: pointer;" onclick="window.location.href='<?= APP_URL ?>/admin/modules/material/index.php?status=low'">
  ...
  <div class="stat-card" style="--stat-color: var(--warning); cursor: pointer;" onclick="window.location.href='<?= APP_URL ?>/admin/modules/orders/index.php'">
  ...
  <div class="stat-card" style="--stat-color: #8b5cf6; cursor: pointer;" onclick="window.location.href='<?= APP_URL ?>/admin/modules/reports/index.php?type=orders'">
...
<!-- ── Quick Stats Row 2 ──────────────────────────────────── -->
<div class="grid grid-4 mb-20">
  <div class="stat-card" style="--stat-color: #06b6d4; cursor: pointer;" onclick="window.location.href='<?= APP_URL ?>/admin/modules/stock_in/index.php'">
  ...
  <div class="stat-card" style="--stat-color: #f97316; cursor: pointer;" onclick="window.location.href='<?= APP_URL ?>/admin/modules/stock_out/index.php'">
  ...
  <div class="stat-card" style="--stat-color: var(--warning); cursor: pointer;" onclick="window.location.href='<?= APP_URL ?>/admin/modules/orders/index.php?status=pending'">
  ...
  <div class="stat-card" style="--stat-color: var(--info); cursor: pointer;" onclick="window.location.href='<?= APP_URL ?>/admin/modules/orders/index.php?status=processing'">
...
<div class="grid" style="grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
  ...
  <div class="card">
    <div class="card-header">
      ...
      <a href="<?= APP_URL ?>/admin/modules/orders/index.php" class="btn btn-ghost btn-sm">
        ...
        <div class="table-responsive">
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                <td><a href="<?= APP_URL ?>/admin/modules/orders/view.php?id=<?= $ord['id'] ?>" class="text-mono" style="font-size:12px;"><?= $ord['order_number'] ?></a></td>
...
<div class="grid" style="grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
  ...
  <div class="card">
    <div class="card-header">
      ...
      <a href="<?= APP_URL ?>/admin/modules/material/index.php" class="btn btn-ghost btn-sm">
