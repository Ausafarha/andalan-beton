...
<div class="page-body">
<div class="mb-20"><a href="<?=APP_URL?>/admin/modules/stock_out/index.php" class="btn btn-ghost btn-sm" style="margin-bottom:8px;"><i class="fas fa-arrow-left"></i> Kembali</a><h2 style="font-size:20px;font-weight:800;">Edit Barang Keluar</h2></div>
