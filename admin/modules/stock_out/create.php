...
<div class="page-body">
<div class="mb-20"><a href="<?=APP_URL?>/admin/modules/stock_out/index.php" class="btn btn-ghost btn-sm" style="margin-bottom:8px;"><i class="fas fa-arrow-left"></i> Kembali</a><h2 style="font-size:20px;font-weight:800;">Catat Barang Keluar</h2></div>
...
<div class="card" style="max-width:700px;">
  ...
  <div class="card-body">
    <form method="POST">
      ...
      <div style="display:flex;gap:10px;"><button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Simpan</button><a href="<?=APP_URL?>/admin/modules/stock_out/index.php" class="btn btn-secondary">Batal</a></div>
    </form>
  </div>
</div>
</div>
