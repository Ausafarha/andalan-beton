...
<div class="flex-between mb-20">
  ...
  <a href="<?= APP_URL ?>/admin/modules/stock_out/create.php" class="btn btn-primary"><i class="fas fa-plus"></i> Catat Barang Keluar</a>
</div>
...
<div class="card">
  <div class="card-body" style="padding:0;">
    <?php if(empty($paginated['items'])):?>
      <div class="empty-state"><div class="empty-state-icon"><i class="fas fa-arrow-up"></i></div><div class="empty-state-title">Belum ada data barang keluar</div><a href="<?=APP_URL?>/admin/modules/stock_out/create.php" class="btn btn-primary" style="margin-top:16px;"><i class="fas fa-plus"></i> Catat Sekarang</a></div>
    <?php else:?>
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <div class="actions">
                  <a href="<?=APP_URL?>/admin/modules/stock_out/edit.php?id=<?=$row['id']?>" class="btn btn-sm btn-secondary"><i class="fas fa-edit"></i></a>
                  <button onclick="confirmDelete('<?=APP_URL?>/admin/modules/stock_out/delete.php?id=<?=$row['id']?>&token=<?=csrfToken()?>','distribusi ini')" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></button>
                </div>
              </td>
            </tr>
            <?php endforeach;?>
