...
if ($_SERVER['REQUEST_METHOD']==='POST' && isset($_POST['update_status'])) {
    if (!verifyCsrf()){setFlash('error','Token tidak valid.');}
        ...
        if (in_array($newStatus,$allowedStatuses)) {
            ...
            redirect(APP_URL.'/admin/modules/orders/view.php?id='.$id);
        }
    }
}
...
<div class="flex-between mb-20">
  <div>
    <a href="<?=APP_URL?>/admin/modules/orders/index.php" class="btn btn-ghost btn-sm" style="margin-bottom:8px;"><i class="fas fa-arrow-left"></i> Kembali</a>
