...
if (!$mat) { setFlash('error', 'Material tidak ditemukan.'); redirect(APP_URL . '/admin/modules/material/index.php'); }
...
<div class="flex-between mb-20">
  <div>
    <a href="<?= APP_URL ?>/admin/modules/material/index.php" class="btn btn-ghost btn-sm" style="margin-bottom:8px;"><i class="fas fa-arrow-left"></i> Kembali</a>
...
<form method="POST" enctype="multipart/form-data">
  ...
  <div style="display:flex;gap:10px;margin-top:8px;">
    ...
    <a href="<?= APP_URL ?>/admin/modules/material/index.php" class="btn btn-secondary btn-lg">Batal</a>
  </div>
</form>
</div>
