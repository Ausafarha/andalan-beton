...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!verifyCsrf()) { $errors[] = 'Token keamanan tidak valid.'; }
        ...
        $data = [
            ...
            'is_active'   => postInt('is_active', 1) ? true : false,
            'is_featured' => postInt('is_featured', 0) ? true : false,
        ];
...
<div class="flex-between mb-20">
  <div>
    <a href="<?= APP_URL ?>/admin/modules/material/index.php" class="btn btn-ghost btn-sm" style="margin-bottom:8px;">
