...
<div class="flex-between mb-20">
  ...
  <a href="<?= APP_URL ?>/admin/modules/material/create.php" class="btn btn-primary">
...
<div class="card mb-20">
  ...
  <i class="fas fa-search search-icon"></i>
      ...
      <?php if ($search || $category || $status): ?>
        <a href="<?= APP_URL ?>/admin/modules/material/index.php" class="btn btn-secondary"><i class="fas fa-times"></i> Reset</a>
      <?php endif; ?>
    </form>
  </div>
</div>
  ...
  <div class="card-body" style="padding:0;">
    <?php if (empty($materials)): ?>
      <div class="empty-state">
        ...
        <a href="<?= APP_URL ?>/admin/modules/material/create.php" class="btn btn-primary" style="margin-top:16px;"><i class="fas fa-plus"></i> Tambah Material</a>
      </div>
    <?php else: ?>
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <div class="actions">
                  <a href="<?= APP_URL ?>/admin/modules/material/edit.php?id=<?= $mat['id'] ?>" class="btn btn-sm btn-secondary" data-tooltip="Edit"><i class="fas fa-edit"></i></a>
                  <button onclick="confirmDelete('<?= APP_URL ?>/admin/modules/material/delete.php?id=<?= $mat['id'] ?>&token=<?= csrfToken() ?>','<?= htmlspecialchars(addslashes($mat['name'])) ?>')" class="btn btn-sm btn-danger" data-tooltip="Hapus"><i class="fas fa-trash"></i></button>
                </div>
               </td>
             </tr>
            <?php endforeach; ?>
  ...
  <?php else: ?>
    ...
    <div class="material-card">
      ...
      <div class="material-card-footer">
        <a href="<?= APP_URL ?>/admin/modules/material/edit.php?id=<?= $mat['id'] ?>" class="btn btn-secondary btn-sm">
          <i class="fas fa-edit"></i> Edit
        </a>
        <button onclick="confirmDelete('<?= APP_URL ?>/admin/modules/material/delete.php?id=<?= $mat['id'] ?>&token=<?= csrfToken() ?>','<?= htmlspecialchars(addslashes($mat['name'])) ?>')" class="btn btn-danger btn-sm">
