...
if (!$row) { setFlash('error','Data tidak ditemukan.'); redirect(APP_URL.'/admin-ab/modules/stock_in/index.php'); }
...
<div class="card" style="max-width:700px;">
  <div class="card-body">
    ...
    <div class="form-group">
      ...
      <div style="display:flex;gap:10px;"><button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Simpan</button><a href="<?= APP_URL ?>/admin-ab/modules/stock_in/index.php" class="btn btn-secondary">Batal</a></div>
    </form>
  </div>
</div>
</div>
