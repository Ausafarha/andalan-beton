...
<div class="flex-between mb-20">
  ...
  <a href="<?= APP_URL ?>/admin-ab/modules/stock_in/create.php" class="btn btn-primary">
  ...
  <div class="card-body" style="padding:0;">
    <?php if (empty($paginated['items'])): ?>
      <div class="empty-state">
        ...
        <a href="<?= APP_URL ?>/admin-ab/modules/stock_in/create.php" class="btn btn-primary" style="margin-top:16px;"><i class="fas fa-plus"></i> Catat Sekarang</a>
      </div>
    <?php else: ?>
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <div class="actions">
                  <a href="<?= APP_URL ?>/admin-ab/modules/stock_in/edit.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-secondary"><i class="fas fa-edit"></i></a>
                  <button onclick="confirmDelete('<?= APP_URL ?>/admin-ab/modules/stock_in/delete.php?id=<?= $row['id'] ?>&token=<?= csrfToken() ?>','penerimaan ini')" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></button>
                </div>
              </td>
            </tr>
            <?php endforeach; ?>
